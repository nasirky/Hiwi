...
2. Run the following command
    ...
    * For Example, if buildroot is installed in buildroot folder under my home directory -> /home/nasir/Downloads/buildroot, then I will use the following command:
